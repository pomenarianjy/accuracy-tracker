...
# 2. Cached Isolated Database Logic Layer
@st.cache_data
...
# 3. Native Dropdown Controller Selector
st.markdown("##### 🔍 Portfolio Filter Core Engine")
selected_ticker = st.selectbox(
    "Select Target Asset Portfolio Ticker:",
    options=sorted(list(TICKER_DB.keys())),
    index=0
)

# 4. Independent Data Flow Layout Logic
static_details = TICKER_DB[selected_ticker]
