    ...
    try:
        ...
        try:
            ...
            if not hist_ytd.empty:
                ...
                ytd_p_start = float(series_close.head(1).values[0])
                ytd_p_end = float(series_close.tail(1).values[0])
        ...
        for offset in range(1, 11):
            ...
            try:
                ...
                if not hist_y.empty:
                    ...
                    val_open = float(close_series.head(1).values[0])
                    val_close = float(close_series.tail(1).values[0])
