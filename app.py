...
def generate_scorecard_metrics(ticker_symbol):
    try:
        ...
        scorecard_list = [
            ...
            {"Feed Source Node": "2. Institutional Peak Target", "Target / Value": f"{high_t:,.2f} {curr}", "Signal State": f"{pct_high:+.2f}%", "Methodology Context": "Optimal multiple expansion projections from sell-side broker models."},
        ...
        # Fixed list indices for YTD math evaluation
        ytd_perf = "N/A"
        ...
        # Fixed list indices for 10-year historical return evaluation
        historical_records = []
